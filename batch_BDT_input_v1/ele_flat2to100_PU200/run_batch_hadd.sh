...
cd ${BATCH_DIR}
date
for filename in /afs/cern.ch/work/j/jheikkil/tools/ntuple-tools/triggerResults/tmp/histos_ele_flat2to100_PU200_eg_v1_*.root; do
    echo ${filename}
    xrdcp ${filename} .
done
...
#mv histos_ele_flat2to100_PU200_eg_v1.root /afs/cern.ch/work/j/jheikkil/tools/ntuple-tools/triggerResults
