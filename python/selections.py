...
sig_lowpthigheta_IDtpg= add_selections(sig_lowpthigheta, [Selection('tpgID975', 'passed ID WP975', 'bdteg>-0.03698097')])
sig_highptloweta_IDtpg= add_selections(sig_highptloweta, [Selection('tpgID975', 'passed ID WP975', 'bdteg>0.03496629')])
sig_highpthigheta_IDtpg=add_selections(sig_highpthigheta, [Selection('tpgID975', 'passed ID WP975', 'bdteg>-0.03698097')])
...
sig_lowptloweta_IDnew = add_selections(sig_lowptloweta, [Selection('newID975', 'passed ID WP975', 'newBDTlowlow>-0.9838970')])
sig_lowpthigheta_IDnew= add_selections(sig_lowpthigheta, [Selection('newID975', 'passed ID WP975', 'newBDTlowhigh>-0.9733922')])
sig_highptloweta_IDnew= add_selections(sig_highptloweta, [Selection('newID975', 'passed ID WP975', 'newBDThighlow>0.9685824')])
sig_highpthigheta_IDnew=add_selections(sig_highpthigheta, [Selection('newID975', 'passed ID WP975', 'newBDThighhigh>0.9722701')])
...
sig_lowptloweta_eval = add_selections([Selection('Pt5to20', '5 <= p_{T}^{L1} <= 20GeV', '(pt <= 20) & (pt >= 5)')],   [Selection('EtaBC', '1.52 < |#eta^{L1}| <= 2.7', '1.52 < abs(eta) <= 2.7')])
sig_lowpthigheta_eval= add_selections([Selection('Pt5to20', '5 <= p_{T}^{L1} <= 20GeV', '(pt <= 20) & (pt >= 5)')],   [Selection('EtaDE', '2.7 < |#eta^{L1}| <= 3', '2.7 < abs(eta) <= 3')])
sig_highptloweta_eval= add_selections([Selection('Pt20', 'p_{T}^{L1}>20GeV', 'pt > 20')], [Selection('EtaBC', '1.52 < |#eta^{L1}| <= 2.7', '1.52 < abs(eta) <= 2.7')])
sig_highpthigheta_eval=add_selections([Selection('Pt20', 'p_{T}^{L1}>20GeV', 'pt > 20')], [Selection('EtaDE', '2.7 < |#eta^{L1}| <= 3', '2.7 < abs(eta) <= 3')])
...
sig_lowptloweta_IDtpg_eval = add_selections(sig_lowptloweta_eval, [Selection('tpgID975', 'passed ID WP975', 'bdteg>0.03496629')])
sig_lowpthigheta_IDtpg_eval= add_selections(sig_lowpthigheta_eval, [Selection('tpgID975', 'passed ID WP975', 'bdteg>-0.03698097')])
sig_highptloweta_IDtpg_eval= add_selections(sig_highptloweta_eval, [Selection('tpgID975', 'passed ID WP975', 'bdteg>0.03496629')])
sig_highpthigheta_IDtpg_eval=add_selections(sig_highpthigheta_eval, [Selection('tpgID975', 'passed ID WP975', 'bdteg>-0.03698097')])
...
sig_lowptloweta_IDnew_eval = add_selections(sig_lowptloweta_eval, [Selection('newID975', 'passed ID WP975', 'newBDTlowlow>-0.9838970')])
sig_lowpthigheta_IDnew_eval= add_selections(sig_lowpthigheta_eval, [Selection('newID975', 'passed ID WP975', 'newBDTlowhigh>-0.9733922')])
sig_highptloweta_IDnew_eval= add_selections(sig_highptloweta_eval, [Selection('newID975', 'passed ID WP975', 'newBDThighlow>0.9685824')])
sig_highpthigheta_IDnew_eval= add_selections(sig_highpthigheta_eval, [Selection('newID975', 'passed ID WP975', 'newBDThighhigh>0.9722701')])
...
mytp_match_selection_sig_foreff = [Selection('EtaBCDE', '1.52 < |#eta^{L1}| < 3', '1.52 < abs(eta) < 3')]+tp_match_selections_forEval_sig_noID+tp_match_selections_forEval_sig_IDtpg+tp_match_selections_forEval_sig_IDnew
...
bkg_lowptloweta_IDtpg = add_selections(bkg_loweta, [Selection('tpgID975_lowpt', 'passed ID WP975', 'bdteg>0.03496629')])
bkg_lowpthigheta_IDtpg= add_selections(bkg_higheta, [Selection('tpgID975_lowpt', 'passed ID WP975', 'bdteg>-0.03698097')])
bkg_highptloweta_IDtpg= add_selections(bkg_loweta, [Selection('tpgID975_highpt', 'passed ID WP975', 'bdteg>0.03496629')])
bkg_highpthigheta_IDtpg=add_selections(bkg_higheta, [Selection('tpgID975_highpt', 'passed ID WP975', 'bdteg>-0.03698097')])
# bkg_lowptloweta_IDtpg = add_selections(bkg_lowptloweta, [Selection('tpgID975', 'passed ID WP975', 'bdteg>0.03496629')])
# bkg_lowpthigheta_IDtpg= add_selections(bkg_lowpthigheta, [Selection('tpgID975', 'passed ID WP975', 'bdteg>-0.03698097')])
# bkg_highptloweta_IDtpg= add_selections(bkg_highptloweta, [Selection('tpgID975', 'passed ID WP975', 'bdteg>0.03496629')])
# bkg_highpthigheta_IDtpg=add_selections(bkg_highpthigheta, [Selection('tpgID975', 'passed ID WP975', 'bdteg>-0.03698097')])
...
bkg_lowptloweta_IDnew = add_selections(bkg_loweta, [Selection('newID975_lowpt', 'passed ID WP975', 'newBDTlowlow>-0.9838970')])
bkg_lowpthigheta_IDnew= add_selections(bkg_higheta, [Selection('newID975_lowpt', 'passed ID WP975', 'newBDTlowhigh>-0.9733922')])
bkg_highptloweta_IDnew= add_selections(bkg_loweta, [Selection('newID975_highpt', 'passed ID WP975', 'newBDThighlow>0.9685824')])
bkg_highpthigheta_IDnew=add_selections(bkg_higheta, [Selection('newID975_highpt', 'passed ID WP975', 'newBDThighhigh>0.9722701')])
# bkg_lowptloweta_IDnew = add_selections(bkg_lowptloweta, [Selection('newID975', 'passed ID WP975', 'newBDTlowlow>-0.9878453')])
# bkg_lowpthigheta_IDnew= add_selections(bkg_lowpthigheta, [Selection('newID975', 'passed ID WP975', 'newBDTlowhigh>-0.9872169')])
# bkg_highptloweta_IDnew= add_selections(bkg_highptloweta, [Selection('newID975', 'passed ID WP975', 'newBDThighlow>0.7768822')])
# bkg_highpthigheta_IDnew=add_selections(bkg_highpthigheta, [Selection('newID975', 'passed ID WP975', 'newBDThighhigh>0.9467015')])
...
# mytp_match_selection_bkg = [Selection('EtaBCDE', '1.52 < |#eta^{L1}| < 3', '1.52 < abs(eta) < 3')]+tp_match_selections_forBDT_bkg_noID+tp_match_selections_forBDT_bkg_IDtpg+tp_match_selections_forBDT_bkg_IDnew             
