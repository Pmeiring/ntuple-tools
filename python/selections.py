...
tp_IDsel_cl3dtrkEllips_lowpt = tp_IDsel_new_lowlow+tp_IDsel_tpg_lowlow
tp_IDcl3dtrkEllips_lowpt  = add_selections(tk_acceptance,  tp_IDsel_cl3dtrkEllips_lowpt)

tp_IDsel_cl3dtrkEllips_highpt = tp_IDsel_new_lowhigh+tp_IDsel_tpg_lowhigh
tp_IDcl3dtrkEllips_highpt = add_selections(tk_acceptance,  tp_IDsel_cl3dtrkEllips_highpt)
