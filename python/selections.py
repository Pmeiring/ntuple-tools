...
sig_lowptloweta_IDtpg_eval = add_selections(sig_lowptloweta_eval, [Selection('tpgID900', 'passed ID WP900', 'bdteg>-0.9986912')])
sig_lowpthigheta_IDtpg_eval= add_selections(sig_lowpthigheta_eval, [Selection('tpgID900', 'passed ID WP900', 'bdteg>-0.9989494')])
sig_highptloweta_IDtpg_eval= add_selections(sig_highptloweta_eval, [Selection('tpgID900', 'passed ID WP900', 'bdteg>0.9963733')])
sig_highpthigheta_IDtpg_eval=add_selections(sig_highpthigheta_eval, [Selection('tpgID900', 'passed ID WP900', 'bdteg>0.9972339')])
...
sig_lowptloweta_IDnew_eval = add_selections(sig_lowptloweta_eval, [Selection('newID900', 'passed ID WP900', 'newBDTlowlow>-0.9335719')])
...
sig_highpthigheta_IDnew_eval= add_selections(sig_highpthigheta_eval, [Selection('newID900', 'passed ID WP900', 'newBDThighhigh>0.9986873')])
...
bkg_lowptloweta_IDtpg = add_selections(bkg_loweta, [Selection('tpgID900_lowpt', 'passed ID WP900', 'bdteg>-0.9986912')])
bkg_lowpthigheta_IDtpg= add_selections(bkg_higheta, [Selection('tpgID900_lowpt', 'passed ID WP900', 'bdteg>-0.9989494')])
bkg_highptloweta_IDtpg= add_selections(bkg_loweta, [Selection('tpgID900_highpt', 'passed ID WP900', 'bdteg>0.9963733')])
bkg_highpthigheta_IDtpg=add_selections(bkg_higheta, [Selection('tpgID900_highpt', 'passed ID WP900', 'bdteg>0.9972339')])
# bkg_lowptloweta_IDtpg = add_selections(bkg_lowptloweta, [Selection('tpgID900', 'passed ID WP900', 'bdteg>0.03496629')])
# bkg_lowpthigheta_IDtpg= add_selections(bkg_lowpthigheta, [Selection('tpgID900', 'passed ID WP900', 'bdteg>-0.03698097')])
# bkg_highptloweta_IDtpg= add_selections(bkg_highptloweta, [Selection('tpgID900', 'passed ID WP900', 'bdteg>0.03496629')])
# bkg_highpthigheta_IDtpg=add_selections(bkg_highpthigheta, [Selection('tpgID900', 'passed ID WP900', 'bdteg>-0.03698097')])
...
bkg_lowptloweta_IDnew = add_selections(bkg_loweta, [Selection('newID900_lowpt', 'passed ID WP900', 'newBDTlowlow>-0.9335719')])
...
bkg_highpthigheta_IDnew=add_selections(bkg_higheta, [Selection('newID900_highpt', 'passed ID WP900', 'newBDThighhigh>0.9986873')])
# bkg_lowptloweta_IDnew = add_selections(bkg_lowptloweta, [Selection('newID900', 'passed ID WP900', 'newBDTlowlow>-0.9878453')])
# bkg_lowpthigheta_IDnew= add_selections(bkg_lowpthigheta, [Selection('newID900', 'passed ID WP900', 'newBDTlowhigh>-0.9872169')])
# bkg_highptloweta_IDnew= add_selections(bkg_highptloweta, [Selection('newID900', 'passed ID WP900', 'newBDThighlow>0.7768822')])
# bkg_highpthigheta_IDnew=add_selections(bkg_highpthigheta, [Selection('newID900', 'passed ID WP900', 'newBDThighhigh>0.9467015')])
