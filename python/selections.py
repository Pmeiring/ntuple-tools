...
tp_pt_selections_forBDT_bkg = [Selection('Pt5to20', '5 < p_{T}^{L1} <= 20GeV', '(pt <= 20) & (pt > 5)'),
                    Selection('Pt20', 'p_{T}^{L1}>20GeV', 'pt > 20')
                    ]                    

tp_pt_selections_forBDT_sig = [Selection('Pt10', 'p_{T}^{L1}>=10GeV', 'pt >= 10'),
...
gen_pt_sel_forBDT_sig = [Selection('Pt5to20', '5 #leq p_{T}^{GEN} <= 20GeV', '(pt >= 5) & (pt <= 20)'),
                     Selection('Pt20', 'p_{T}^{GEN}>=20GeV', 'pt > 20'),
                     ]
