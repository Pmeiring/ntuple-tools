...
class CustomHistos(BaseHistos):
    def __init__(self, name, root_file=None, debug=False):
        if not root_file:
            ...
            self.h_nclusters_pt_0_5 = ROOT.TH1F(name+'_nclusters_pt_0_5','Number of 3DClusters within #Delta R = 1 of a SimTrack with certain pT',5000,0,5000)
            self.h_nclusters_pt_5_10 = ROOT.TH1F(name+'_nclusters_pt_5_10','Number of 3DClusters within #Delta R = 1 of a SimTrack with certain pT',5000,0,5000)
            self.h_nclusters_pt_10_20 = ROOT.TH1F(name+'_nclusters_pt_10_20','Number of 3DClusters within #Delta R = 1 of a SimTrack with certain pT',5000,0,5000)
            self.h_nclusters_pt_20_30 = ROOT.TH1F(name+'_nclusters_pt_20_30','Number of 3DClusters within #Delta R = 1 of a SimTrack with certain pT',5000,0,5000)
            self.h_nclusters_pt_30_40 = ROOT.TH1F(name+'_nclusters_pt_30_40','Number of 3DClusters within #Delta R = 1 of a SimTrack with certain pT',5000,0,5000)
            self.h_nclusters_pt_40_50 = ROOT.TH1F(name+'_nclusters_pt_40_50','Number of 3DClusters within #Delta R = 1 of a SimTrack with certain pT',5000,0,5000)
            self.h_nclusters_pt_50_1000 = ROOT.TH1F(name+'_nclusters_pt_50_1000','Number of 3DClusters within #Delta R = 1 of a SimTrack with certain pT',5000,0,5000)
