...
class CustomHistos(BaseHistos):
    def __init__(self, name, root_file=None, debug=False):
        if not root_file:
            ...
            self.h_nclusters = ROOT.TH1F(name+'_nclusters','Number of 3DClusters',5000,0,5000)
            self.h_nclusters_dR0p025 = ROOT.TH1F(name+'_nclusters_dR0p025','Number of 3DClusters within #Delta R = X of SimTrack',5000,0,5000)
            self.h_nclusters_dR0p05 = ROOT.TH1F(name+'_nclusters_dR0p05','Number of 3DClusters within #Delta R = X of SimTrack',5000,0,5000)
            self.h_nclusters_dR0p1 = ROOT.TH1F(name+'_nclusters_dR0p1','Number of 3DClusters within #Delta R = X of SimTrack',5000,0,5000)
            self.h_nclusters_dR0p2 = ROOT.TH1F(name+'_nclusters_dR0p2','Number of 3DClusters within #Delta R = X of SimTrack',5000,0,5000)
            self.h_nclusters_dR0p3 = ROOT.TH1F(name+'_nclusters_dR0p3','Number of 3DClusters within #Delta R = X of SimTrack',5000,0,5000)
            self.h_nclusters_dR0p4 = ROOT.TH1F(name+'_nclusters_dR0p4','Number of 3DClusters within #Delta R = X of SimTrack',5000,0,5000)
            self.h_nclusters_dR1p0 = ROOT.TH1F(name+'_nclusters_dR1p0','Number of 3DClusters within #Delta R = X of SimTrack',5000,0,5000)
            self.h_nclusters_dR100 = ROOT.TH1F(name+'_nclusters_dR100','Number of 3DClusters within #Delta R = X of SimTrack',5000,0,5000)
            self.h_nclusters_pt_0_5 = ROOT.TH1F(name+'_nclusters_pt_0_5','Number of 3DClusters within #Delta R = 0.2 of a SimTrack with certain pT',5000,0,5000)
            self.h_nclusters_pt_5_10 = ROOT.TH1F(name+'_nclusters_pt_5_10','Number of 3DClusters within #Delta R = 0.2 of a SimTrack with certain pT',5000,0,5000)
            self.h_nclusters_pt_10_20 = ROOT.TH1F(name+'_nclusters_pt_10_20','Number of 3DClusters within #Delta R = 0.2 of a SimTrack with certain pT',5000,0,5000)
            self.h_nclusters_pt_20_30 = ROOT.TH1F(name+'_nclusters_pt_20_30','Number of 3DClusters within #Delta R = 0.2 of a SimTrack with certain pT',5000,0,5000)
            self.h_nclusters_pt_30_40 = ROOT.TH1F(name+'_nclusters_pt_30_40','Number of 3DClusters within #Delta R = 0.2 of a SimTrack with certain pT',5000,0,5000)
            self.h_nclusters_pt_40_50 = ROOT.TH1F(name+'_nclusters_pt_40_50','Number of 3DClusters within #Delta R = 0.2 of a SimTrack with certain pT',5000,0,5000)
            self.h_nclusters_pt_50_1000 = ROOT.TH1F(name+'_nclusters_pt_50_1000','Number of 3DClusters within #Delta R = 0.2 of a SimTrack with certain pT',5000,0,5000)
            ...
            self.h_dR_any_GENpt_50_1000 = ROOT.TH1F(name+'_dR_any_GENpt_50_1000','#Delta R (SimTrack, Any 3DCluster)',1000,0,10)
